...
```{ojs}
viewof normal_mu = Inputs.range([-10, 10], { label: "Minimum (a)", step: 0.1, value: 0 })
viewof normal_var = Inputs.range([0, 10], { label: "Maximum (b)", step: 0.1, value: 1 })
...
```{ojs}
viewof gamma_a = Inputs.range([0.4, 5], { label: "Minimum (a)", step: 0.1, value: 1 })
viewof gamma_b = Inputs.range([0.1, 5], { label: "Maximum (b)", step: 0.1, value: 1 })
...
viewof chi_dof = Inputs.range([1, 5], { label: "Minimum (n)", step: 1, value: 1 })
...
viewof exp_b = Inputs.range([0.1, 5], { label: "Minimum (n)", step: 0.1, value: 1 })
