...
& = \sum_{k=0}^n e^{-\lambda_1}\frac{\lambda_1^k}{k!} \cdot e^{\lambda_2} \frac{\lambda^{n-k}}{(n-k)!} \\
...
This reuslt does confirm to our intuitions because there are "more ways" to get a value of 1 for example than any other point.
